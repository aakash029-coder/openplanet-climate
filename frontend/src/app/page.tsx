...
export default function HomePage() {
  ...
  // ✅ FIX: iOS Safari + Android — html aur body dono pe overscroll band
  // Ye sirf HomePage par apply hoga, unmount pe restore ho jaayega
  useEffect(() => {
    ...
    body.style.touchAction = 'pan-y'; // sirf vertical scroll, bounce nahi
  ...
  return (
    <div
      ...
      style={{
        ...
        // ✅ FIX: content ko viewport ke andar rakho — header/footer ke bahar nahi jaayega
        WebkitOverflowScrolling: 'touch',
      }}
    >
      <main className="w-full max-w-7xl px-4 md:px-6 flex flex-col items-center pb-24 gap-24 md:gap-32">

        {/* 1. HERO */}
        <section className="w-full min-h-[80vh] flex flex-col items-center justify-center text-center relative z-10 py-12 md:py-0">

          <h1 className="text-4xl md:text-7xl font-extrabold tracking-tighter mb-6 md:mb-8 leading-tight drop-shadow-2xl">
          ...
          <p className="text-sm md:text-lg text-slate-400 font-light tracking-wide mb-10 md:mb-12 max-w-3xl mx-auto leading-relaxed uppercase tracking-[0.1em]">
        ...
        <section
          id="discover"
          className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-black/40 backdrop-blur-2xl border border-white/5 p-6 md:p-16 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.8)] hover:border-cyan-500/20 transition-colors"
        >
          <div className="lg:col-span-6 flex flex-col gap-6">
            <h2 className="text-2xl md:text-5xl font-bold text-white tracking-tight leading-tight uppercase">
              Localized{' '}
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div
                key={idx}
                className="bg-white/[0.02] border border-white/5 p-5 md:p-6 rounded-2xl hover:bg-black/60 hover:border-cyan-500/40 hover:shadow-[0_0_20px_rgba(34,211,238,0.1)] transition-all"
              >
        ...
        <section id="about" className="w-full flex flex-col items-center">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-cyan-500/80 font-mono mt-4 max-w-2xl text-[10px] uppercase tracking-widest">
              Built on peer-reviewed epidemiology & spatial computing.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 w-full">
            {[
              ...
              <div
                key={idx}
                className="bg-black/40 backdrop-blur-xl border border-white/5 p-6 md:p-8 rounded-2xl hover:border-cyan-500/30 hover:bg-black/80 hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] transition-all duration-300 group cursor-default"
              >
                <h4 className="text-[10px] font-bold text-slate-400 group-hover:text-cyan-300 tracking-[0.2em] uppercase transition-colors">
                  {title}
                </h4>
              </div>
            ))}
        ...
        {/* 4. FINAL CTA */}
        <section className="w-full flex flex-col items-center text-center bg-black/50 border border-white/5 py-16 md:py-24 backdrop-blur-2xl rounded-3xl overflow-hidden relative shadow-[0_0_50px_rgba(0,0,0,0.8)]">
          <div className="absolute inset-0 bg-gradient-to-b from-cyan-900/10 to-transparent pointer-events-none"></div>
          <h3 className="text-2xl md:text-5xl font-serif text-slate-200 mb-8 md:mb-10 tracking-wide drop-shadow-lg px-4">
          ...
          <div className="relative w-full max-w-md bg-[#050b14]/90 border border-cyan-500/30 rounded-2xl shadow-[0_0_50px_rgba(34,211,238,0.15)] p-8 overflow-hidden animate-in zoom-in-95 duration-300 backdrop-blur-xl">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-xs font-mono font-bold text-cyan-300 uppercase tracking-[0.3em]">Authentication</h2>
              </div>
