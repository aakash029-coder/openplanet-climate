...
export default function Navbar() {
  ...
  // Stylish active link logic with cyan glow
  ...
  return (
    // 👇 FIXED: Header ab rigid hai (hilega nahi) aur background extra dark glossy hai
    <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-8 lg:px-16 xl:px-24 h-20 bg-[#050505]/40 backdrop-blur-2xl border-b border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.9)]">
      
      {/* Brand Logo - Fixed & Rigid */}
      <Link href="/" className="flex items-center gap-4 group">
        <div className="relative flex items-center justify-center w-9 h-9 bg-black/50 border border-white/10 shadow-[0_0_15px_rgba(255,255,255,0.05)] overflow-hidden group-hover:border-cyan-500/50 transition-all rounded-lg">
          <span className="relative text-white font-serif font-black text-xs tracking-tighter">OP</span>
        </div>
      ...
      {/* Center Navigation Links - Fixed in Center */}
