    ...
    <div className="w-full flex flex-col items-center py-4 md:py-6 px-3 md:px-4 bg-[var(--canvas)] min-h-screen gap-0">
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-1.5 min-w-0 min-h-0 w-full">
          <div
            ref={mapContainerRef}
            className={`map-canvas-container overflow-hidden relative transition-all duration-500 ease-in-out md:h-[clamp(44vh,calc(100vh_-_112px),100vh)] min-h-[220px] ${isInitialized ? 'h-[46vh]' : 'h-[28vh]'}`}
