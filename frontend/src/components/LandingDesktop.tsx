  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen" style={{ overscrollBehavior: 'none' }}>
      <main className="w-full max-w-7xl px-5 md:px-8 lg:px-12 flex flex-col items-center pb-24 gap-20 md:gap-32 lg:gap-40 pt-12 md:pt-16">
        ...
        {/* ── 7. TRUST STRIP ── */}
        <section className="w-full flex flex-col items-center text-center gap-4 py-10 px-6"
                 style={{ borderTop: '1px solid var(--hairline)' }}>
          <a href="https://doi.org/10.5281/zenodo.19340991" target="_blank" rel="noopener noreferrer"
             className="flex items-center gap-2 transition-colors duration-150 hover:text-white group"
             style={{ color: 'var(--muted)' }}>
            ...
            <span className="font-mono text-[8px] tracking-[0.12em]">Zenodo · DOI 10.5281/zenodo.19340991</span>
          </a>
