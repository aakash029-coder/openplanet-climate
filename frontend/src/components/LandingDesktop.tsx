        ...
        >
          ...
          <div className="flex flex-col items-center gap-4">
            <button
              ...
              className="btn-primary inline-flex items-center gap-2.5 bg-white text-black font-sans font-semibold text-xs px-10 py-3.5 uppercase tracking-wider transition-all duration-150 hover:bg-zinc-100 min-h-[48px]"
            >
              Analyse a City
        ...
        <section className="w-full relative flex flex-col items-center text-center py-12 md:py-16 px-6 overflow-hidden glass-panel">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 relative z-10">
            <button
              onClick={handleStartSimulation}
              style={{ touchAction: 'manipulation' }}
              className="btn-primary inline-flex items-center gap-2.5 bg-white text-black font-sans font-semibold text-xs px-12 py-4 uppercase tracking-wider transition-all duration-150 hover:bg-zinc-50 min-h-[52px]"
            >
              Analyse a City
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </button>
