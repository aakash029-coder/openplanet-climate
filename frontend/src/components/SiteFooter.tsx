        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          <div className="flex items-center gap-3.5 shrink-0">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-2 mt-2" style={{ maxWidth: '260px' }}>
                <div>
                  <p className="font-mono text-[6px] uppercase tracking-widest mb-0.5" style={{ color: 'var(--copper)' }}>Published Research</p>
                  <p className="font-mono text-[7px] leading-snug" style={{ color: 'var(--muted)' }}>
                    Published on{' '}
                    <a href="https://doi.org/10.5281/zenodo.19340991" target="_blank" rel="noopener noreferrer"
                       className="hover:text-white transition-colors" style={{ color: 'var(--reference)' }}>
                      Zenodo
                    </a>
                    {' '}— open-science repository backed by CERN &amp; OpenAIRE.{' '}
                    <span style={{ color: 'var(--muted)', opacity: 0.6 }}>DOI 10.5281/zenodo.19340991</span>
                  </p>
                </div>
                <div>
                  <p className="font-mono text-[6px] uppercase tracking-widest mb-0.5" style={{ color: 'var(--copper)' }}>Recognised By</p>
                  <ul className="space-y-0.5">
                    {[
                      ...
                      <li key={p.label} className="flex items-center gap-1.5">
                        <span className="w-0.5 h-0.5 rounded-full shrink-0" style={{ background: 'var(--copper)' }} />
                        <a href={p.href} target="_blank" rel="noopener noreferrer"
                           className="font-mono text-[7px] tracking-[0.08em] hover:text-white transition-colors"
                           style={{ color: 'var(--muted)' }}>
                          {p.label}
                        </a>
                      </li>
